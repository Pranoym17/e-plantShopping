        ...
        <div>
            <div className="navbar">
                ...
                <div className="nav-links">
                    ...
                    <div>
                        <a href="#" onClick={handleCartClick} className="cart-link" aria-label="Shopping cart">
                            <span className="cart_quantity_count">{cartQuantity}</span>
                            <svg className="cart-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" aria-hidden="true">
